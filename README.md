...
![Last commit date](https://img.shields.io/github/last-commit/ddotta/awesome-polars?style=flat\&label=last%20commit) [![Check Links](https://github.com/ddotta/awesome-polars/actions/workflows/link-check.yml/badge.svg)](https://github.com/ddotta/awesome-polars/actions/workflows/link-check.yml) ⭐ 1,117 | 🐛 0 | 📅 2026-08-26 [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) [![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/ddotta/awesome-polars/)
...
Just follow the [guidelines](https://github.com/ddotta/awesome-polars/blob/main/.github/CONTRIBUTING.md) ⭐ 1,117 | 🐛 0 | 📅 2026-08-26 by either:

* Filling a [suggestion issue](https://github.com/ddotta/awesome-polars/issues/new?assignees=ddotta\&labels=\&template=suggestion.yml) ⭐ 1,117 | 🐛 0 | 📅 2026-08-26.
* Opening a [pull request](https://github.com/ddotta/awesome-polars/pulls) ⭐ 1,117 | 🐛 0 | 📅 2026-08-26.
...
* [polars-io-tools](https://github.com/Point72/polars-io-tools) ⭐ 21 | 🐛 5 | 🌐 Python | 📅 2026-08-28 - Polars plugin extending lazy execution and predicate pushdown across external data sources (SQL, ClickHouse, Datadog, Delta Lake) by [@Point72](https://github.com/Point72/).
...
* [diffly](https://github.com/Quantco/diffly) ⭐ 46 | 🐛 7 | 🌐 Python | 📅 2026-08-03 - Python utility for programatically identifying differences between Polars DataFrames including schema differences, row-level mismatches, and column value changes by [@Quantco](https://github.com/Quantco).
...
* [polars-expr-hopper](https://github.com/lmmx/polars-expr-hopper) ⭐ 8 | 🐛 1 | 🌐 Python | 📅 2026-08-24 - Polars plugin providing a hopper of expressions for automatic, schema-aware application by [@lmmx](https://github.com/lmmx).
* [polars-schema-index](https://github.com/lmmx/polars-schema-index) ⭐ 6 | 🐛 1 | 🌐 Python | 📅 2026-08-24 - Polars plugin for flattening nested data by [@lmmx](https://github.com/lmmx).
...
* [polars-h3](https://github.com/Filimoa/polars-h3) ⭐ 130 | 🐛 2 | 🌐 Python | 📅 2026-08-31 - Efficient hexagonal indexing for large-scale geospatial analysis by [@Filimoa](https://github.com/Filimoa).
...
* [daffy](https://github.com/vertti/daffy/) ⭐ 58 | 🐛 6 | 🌐 Python | 📅 2026-08-30 - Decorator-first DataFrame contracts/validation (columns/dtypes/constraints) at function boundaries. Supports Polars/Pandas/PyArrow/Modin by [@vertti](https://github.com/vertti).
* [truthound](https://github.com/seadonggyun4/truthound) ⭐ 18 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Enterprise data quality framework with 289 validators, auto-profiling, and zero-configuration schema inference by [@seadonggyun4](https://github.com/seadonggyun4).
...
* [polars-candle](https://github.com/wdoppenberg/polars-candle) ⭐ 31 | 🐛 5 | 🌐 Python | 📅 2026-06-15 - Polars plugin for running [candle](https://github.com/huggingface/candle) ⭐ 20,977 | 🐛 895 | 🌐 Rust | 📅 2026-08-29 ML models on Polars DataFrames by [@wdoppenberg](https://github.com/wdoppenberg).
...
* [polars-skills](https://github.com/polars-inc/skills) ⭐ 73 | 🐛 1 | 📅 2026-08-21 - Official AI agent skills by [@polars-inc](https://github.com/polars-inc).
...
* [jquantstats](https://github.com/tschm/jquantstats) ⭐ 43 | 🐛 1 | 🌐 Python | 📅 2026-08-31 - Polars/Narwhals-centric tool for the analysis of financial time series data by [@tschm](https://github.com/tschm).
...
* [polars for Python](https://github.com/pola-rs/polars/tree/master/py-polars) ⭐ 39,565 | 🐛 2,876 | 🌐 Rust | 📅 2026-08-31 - [Python](https://www.python.org/) `polars` package to use polars DataFrame from Python.
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,711 | 🐛 247 | 🌐 Python | 📅 2026-08-31 - Python files that provides an extremely lightweight compatibility layer between Polars, Pandas, cuDF, and Modin by [@narwhals-dev](https://github.com/narwhals-dev).
...
* [polarscope](https://github.com/pytoned/polarscope) ⭐ 13 | 🐛 3 | 🌐 Python | 📅 2026-08-29 - Polars plugin for quick data summary, cleaning and visualization of Polars dataframes by @pytoned.
...
* [flexviz](https://github.com/flex-analytics/flexviz) ⭐ 10 | 🐛 2 | 🌐 Python | 📅 2026-08-30 - Python library for interactive, cross-filterable charts on 100M+ rows, powered by lazy Polars aggregations and Rust kernels by [@jvdd](https://github.com/jvdd).
...
* [polars\_hash](https://github.com/ion-elgreco/polars-hash) ⭐ 94 | 🐛 0 | 🌐 Python | 📅 2026-08-29 - Python package that provides stable hashing functionality across different Polars versions by [@ion-elgreco](https://github.com/ion-elgreco).
...
* [immunum-polars](https://github.com/ENPICOM/immunum) ⭐ 32 | 🐛 18 | 🌐 Rust | 📅 2026-08-28 - high-performance plugin for antibody segmentation and numbering, with up to 1,000,000 antibodies per second on 48-core CPU machine.
...
* [polars for Rust](https://github.com/pola-rs/polars/tree/master/crates/polars) ⭐ 39,565 | 🐛 2,876 | 🌐 Rust | 📅 2026-08-31 - [Rust](https://www.rust-lang.org/) `polars` crate to use polars DataFrame with Rust.
* [GeoPolars](https://geopolars.org/) `Geopolars` pre-alpha Rust crate that extends the Polars DataFrame library for use with geospatial data (not in active development - see [top of readme](https://github.com/geopolars/geopolars) ⭐ 911 | 🐛 27 | 🌐 Python | 📅 2025-12-10).
...
* [rpolars for R](https://github.com/pola-rs/r-polars) ⭐ 568 | 🐛 55 | 🌐 R | 📅 2026-08-30 - [R](https://www.r-project.org/) `rpolars` package to use polars DataFrame from R.
...
* [r-polars-dashboard](https://github.com/etiennebacher/r-polars-dashboard) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-08-30 - Dashboard comparing r-polars and py-polars APIs.
...
* [scala-polars for Scala and Java](https://github.com/chitralverma/scala-polars) ⭐ 112 | 🐛 10 | 🌐 Scala | 📅 2026-08-03 - [Scala](https://scala-lang.org/) - [Java](https://www.java.com/fr/) `scala-polars` is a library for using Polars in Scala and Java projects by [@chitralverma](https://github.com/chitralverma).

### Ruby

* [polars for Ruby](https://github.com/ankane/polars-ruby) ⭐ 993 | 🐛 1 | 🌐 Ruby | 📅 2026-08-27 - [Ruby](https://www.ruby-lang.org/en/) `polars-df` gems to use Polars with Ruby.
...
* [octopolars](https://github.com/lmmx/octopolars) ⭐ 2 | 🐛 3 | 🌐 Python | 📅 2026-08-24 - Pull, filter, and walk a GitHub user's repositories with Polars by [@lmmx](https://github.com/lmmx).
...
* [Pandas2 and Polars for Feature Engineering](https://www.hopsworks.ai/post/pandas2-and-polars-for-feature-engineering) - A blog post that compares Pandas2 and Polars for Feature Engineering tasks with Python by [@hopswork](https://github.com/logicalclocks/hopsworks) ⭐ 1,303 | 🐛 16 | 🌐 Java | 📅 2025-02-10.
...
Thanks goes to these [contributors](https://github.com/ddotta/awesome-polars/graphs/contributors) ⭐ 1,117 | 🐛 0 | 📅 2026-08-26!
