...
![Last commit date](https://img.shields.io/github/last-commit/ddotta/awesome-polars?style=flat\&label=last%20commit) [![Check Links](https://github.com/ddotta/awesome-polars/actions/workflows/link-check.yml/badge.svg)](https://github.com/ddotta/awesome-polars/actions/workflows/link-check.yml) ⭐ 1,116 | 🐛 1 | 📅 2026-08-24 [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) [![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/ddotta/awesome-polars/)
...
Just follow the [guidelines](https://github.com/ddotta/awesome-polars/blob/main/.github/CONTRIBUTING.md) ⭐ 1,116 | 🐛 1 | 📅 2026-08-24 by either:

* Filling a [suggestion issue](https://github.com/ddotta/awesome-polars/issues/new?assignees=ddotta\&labels=\&template=suggestion.yml) ⭐ 1,116 | 🐛 1 | 📅 2026-08-24.
* Opening a [pull request](https://github.com/ddotta/awesome-polars/pulls) ⭐ 1,116 | 🐛 1 | 📅 2026-08-24.
...
* [Ibis Python package for Polars](https://ibis-project.org/backends/polars) - [Ibis](https://github.com/ibis-project/ibis) ⭐ 6,641 | 🐛 525 | 🌐 Python | 📅 2026-08-21 is a Python library that provides a lightweight, universal interface for data wrangling. It can be used with Polars.
...
* [polars-candle](https://github.com/wdoppenberg/polars-candle) ⭐ 31 | 🐛 5 | 🌐 Python | 📅 2026-06-15 - Polars plugin for running [candle](https://github.com/huggingface/candle) ⭐ 20,946 | 🐛 887 | 🌐 Rust | 📅 2026-08-23 ML models on Polars DataFrames by [@wdoppenberg](https://github.com/wdoppenberg).
...
* [polars for Python](https://github.com/pola-rs/polars/tree/master/py-polars) ⭐ 39,468 | 🐛 2,864 | 🌐 Rust | 📅 2026-08-24 - [Python](https://www.python.org/) `polars` package to use polars DataFrame from Python.
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,705 | 🐛 246 | 🌐 Python | 📅 2026-08-23 - Python files that provides an extremely lightweight compatibility layer between Polars, Pandas, cuDF, and Modin by [@narwhals-dev](https://github.com/narwhals-dev).
...
* [polars-bio](http://biodatageeks.org/polars-bio/) - [Polars plugin](https://github.com/biodatageeks/polars-bio) ⭐ 193 | 🐛 45 | 🌐 Python | 📅 2026-08-23 for large-scale genomic analyses which is easy to use and considerably faster and more scalable than existing alternatives by [@biodatageeks](https://github.com/biodatageeks).
...
* [polars for Rust](https://github.com/pola-rs/polars/tree/master/crates/polars) ⭐ 39,468 | 🐛 2,864 | 🌐 Rust | 📅 2026-08-24 - [Rust](https://www.rust-lang.org/) `polars` crate to use polars DataFrame with Rust.
...
* [r-polars-dashboard](https://github.com/etiennebacher/r-polars-dashboard) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-08-24 - Dashboard comparing r-polars and py-polars APIs.
...
* [nodejs-polars for Node.js](https://github.com/pola-rs/nodejs-polars) ⭐ 747 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-21 - [Node.js](https://nodejs.org/en/) `nodejs-polars` package to use polars DataFrame from Node.js.
...
Thanks goes to these [contributors](https://github.com/ddotta/awesome-polars/graphs/contributors) ⭐ 1,116 | 🐛 1 | 📅 2026-08-24!
