...
![Last commit date](https://img.shields.io/github/last-commit/ddotta/awesome-polars?style=flat\&label=last%20commit) [![Check Links](https://github.com/ddotta/awesome-polars/actions/workflows/link-check.yml/badge.svg)](https://github.com/ddotta/awesome-polars/actions/workflows/link-check.yml) ⭐ 1,120 | 🐛 0 | 📅 2026-09-17 [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) [![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/ddotta/awesome-polars/)
...
Just follow the [guidelines](https://github.com/ddotta/awesome-polars/blob/main/.github/CONTRIBUTING.md) ⭐ 1,120 | 🐛 0 | 📅 2026-09-17 by either:

* Filling a [suggestion issue](https://github.com/ddotta/awesome-polars/issues/new?assignees=ddotta\&labels=\&template=suggestion.yml) ⭐ 1,120 | 🐛 0 | 📅 2026-09-17.
* Opening a [pull request](https://github.com/ddotta/awesome-polars/pulls) ⭐ 1,120 | 🐛 0 | 📅 2026-09-17.
...
* [Shared library plugins for Polars](https://github.com/pola-rs/pyo3-polars) ⚠️ Archived.
...
You can also try to [Polars plugins Cookiecutter](https://github.com/MarcoGorelli/cookiecutter-polars-plugins) ⭐ 82 | 🐛 4 | 🌐 Python | 📅 2025-12-05 by [@MarcoGorelli](https://github.com/MarcoGorelli) which provides a template to quickly scaffold a Rust-based plugin for the Polars Python library.

#### Import / Export

* [polars\_readstat](https://github.com/jrothbaum/polars_readstat) ⭐ 38 | 🐛 1 | 🌐 Rust | 📅 2026-09-15 - Polars IO plugin to read SAS, Stata and SPSS file by [@jrothbaum](https://github.com/jrothbaum).
* [polars-io-tools](https://github.com/Point72/polars-io-tools) ⭐ 25 | 🐛 2 | 🌐 Python | 📅 2026-09-17 - Polars plugin extending lazy execution and predicate pushdown across external data sources (SQL, ClickHouse, Datadog, Delta Lake) by [@Point72](https://github.com/Point72/).
...
* [polars-root](https://github.com/DanielMaysWilliams/polars-root) ⭐ 5 | 🐛 1 | 🌐 Python | 📅 2026-06-29 - Polars plugin for reading CERN's ROOT file format by [@DanielMaysWilliams](https://github.com/DanielMaysWilliams).
* [polars-fastx](https://github.com/apcamargo/polars-fastx) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2025-12-12 - Polars plugin for parsing FASTA and FASTQ files into DataFrames by [@apcamargo](https://github.com/apcamargo).
* [polars-mongo](https://github.com/AThomas314/polars-mongo/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2026-05-28 - Polars IO plugin that extends polars to read from mongodb collections via the LazyFrame apis by [@AThomas314](https://github.com/AThomas314).
...
* [Ibis Python package for Polars](https://ibis-project.org/backends/polars) - [Ibis](https://github.com/ibis-project/ibis) ⭐ 6,661 | 🐛 544 | 🌐 Python | 📅 2026-09-17 is a Python library that provides a lightweight, universal interface for data wrangling. It can be used with Polars.
* [diffly](https://github.com/Quantco/diffly) ⭐ 47 | 🐛 6 | 🌐 Python | 📅 2026-09-09 - Python utility for programatically identifying differences between Polars DataFrames including schema differences, row-level mismatches, and column value changes by [@Quantco](https://github.com/Quantco).
...
* [polars-permute-plugin](https://github.com/lmmx/polars-permute-plugin) ⭐ 15 | 🐛 2 | 🌐 Python | 📅 2026-09-14 - Polars plugin for easily reordering DataFrame columns by [@lmmx](https://github.com/lmmx).
* [polars-expr-hopper](https://github.com/lmmx/polars-expr-hopper) ⭐ 8 | 🐛 1 | 🌐 Python | 📅 2026-09-14 - Polars plugin providing a hopper of expressions for automatic, schema-aware application by [@lmmx](https://github.com/lmmx).
* [polars-schema-index](https://github.com/lmmx/polars-schema-index) ⭐ 6 | 🐛 1 | 🌐 Python | 📅 2026-09-14 - Polars plugin for flattening nested data by [@lmmx](https://github.com/lmmx).
...
* [polars-st](https://github.com/Oreilles/polars-st) ⭐ 196 | 🐛 9 | 🌐 Python | 📅 2026-09-14 - Polars plugin that provides geographical/spatial operations on Polars DataFrames, Series, and Expressions by [@Oreilles](https://github.com/Oreilles).
* [polars-h3](https://github.com/Filimoa/polars-h3) ⭐ 130 | 🐛 3 | 🌐 Python | 📅 2026-09-03 - Efficient hexagonal indexing for large-scale geospatial analysis by [@Filimoa](https://github.com/Filimoa).
...
* [dataframely](https://github.com/Quantco/dataframely) ⭐ 618 | 🐛 19 | 🌐 Python | 📅 2026-09-18 - Polars plugin that provides schema and other rule validation for Polars DataFrames by [@Quantco](https://github.com/Quantco).
...
* [daffy](https://github.com/vertti/daffy/) ⭐ 59 | 🐛 1 | 🌐 Python | 📅 2026-09-18 - Decorator-first DataFrame contracts/validation (columns/dtypes/constraints) at function boundaries. Supports Polars/Pandas/PyArrow/Modin by [@vertti](https://github.com/vertti).
* [truthound](https://github.com/seadonggyun4/truthound) ⭐ 19 | 🐛 0 | 🌐 Python | 📅 2026-09-14 - Enterprise data quality framework with 289 validators, auto-profiling, and zero-configuration schema inference by [@seadonggyun4](https://github.com/seadonggyun4).
...
* [iban\_validation\_polars](https://github.com/ericqu/iban_validation/tree/main/iban_validation_polars) ⭐ 1 | 🐛 0 | 🌐 HTML | 📅 2026-09-08 - A package to facilitate validation of IBANs and getting bank identifier and branch identifier as a Polars plugin by [@ericqu](https://github.com/ericqu).

#### Security / Privacy

* [maskops](https://github.com/fcarvajalbrown/maskops) ⭐ 21 | 🐛 0 | 🌐 Python | 📅 2026-08-30 - Native Polars expression plugin for high-speed PII masking and detection, powered by Rust. Supports asterisk masking, HMAC-SHA256 deterministic pseudonymization, and FF3-1 format-preserving encryption. GDPR Art. 4(5)-compliant by [@fcarvajalbrown](https://github.com/fcarvajalbrown).

#### String parsing

* [polars\_iptools](https://github.com/erichutchins/polars_iptools) ⭐ 34 | 🐛 0 | 🌐 Python | 📅 2026-08-22 - Polars plugin for IP address parsing and enrichment including geolocation by [@erichutchins](https://github.com/erichutchins).
* [polars-url](https://github.com/condekind/polars-url) ⭐ 9 | 🐛 5 | 🌐 Python | 📅 2026-04-23 - Polars plugin to parse/extract fields from urls by [@condekind](https://github.com/condekind).
* [polars-textproc](https://github.com/Apsod/polars-textproc) ⭐ 2 | 🐛 0 | 🌐 Rust | 📅 2026-02-12 - Polars plugins to apply gopher repetetition penalties and fasttext classifiers to text data by [@Apsod](https://github.com/Apsod).

#### Text similarity / Fuzzy Matching

* [polars-distance](https://github.com/ion-elgreco/polars-distance) ⭐ 108 | 🐛 6 | 🌐 Rust | 📅 2025-04-20 - Polars plugin for text similarity/pairwise distance functions by [@ion-elgreco](https://github.com/ion-elgreco).
* [polars-fuzzy-match](https://github.com/bnm3k/polars-fuzzy-match) ⭐ 36 | 🐛 5 | 🌐 Python | 📅 2024-08-15 - Python package for fuzzy matching with Polars, i.e. matching text elements that are similar but not exactly identical by bnm3k.
* [polars-strsim](https://github.com/foxcroftjn/polars-strsim) ⭐ 29 | 🐛 0 | 🌐 Rust | 📅 2025-04-25 - Polars plugin that computes string similarity measures directly on a Polars dataframe by [@foxcroftjn](https://github.com/foxcroftjn).
* [polars\_sim](https://github.com/schemaitat/polars_sim) ⭐ 19 | 🐛 0 | 🌐 Rust | 📅 2026-04-15 - Polars plugin that implements fast approximate joins on string columns for polars dataframes by [@schemaitat](https://github.com/schemaitat).

#### Time series / Datetime

* [functime](https://github.com/functime-org/functime) ⭐ 1,185 | 🐛 56 | 🌐 Python | 📅 2026-05-03 - Machine learning Python package built on Polars for time-series predictions by [@functime-org](https://github.com/functime-org). According to the developpers, it's the world's fastest and most feature-full machine learning forecasting library !
* [polars-talib](https://github.com/Yvictor/polars_ta_extension) ⭐ 249 | 🐛 10 | 🌐 Rust | 📅 2026-06-04 - Polars extension for Ta-Lib - support Ta-Lib functions in Polars expressions by [@Yvictor](https://github.com/Yvictor).
...
* [polars-ds](https://github.com/abstractqqq/polars_ds_extension) ⭐ 656 | 🐛 10 | 🌐 Rust | 📅 2026-08-16 - Polars extension for general data science use cases by [@abstractqqq](https://github.com/abstractqqq).
...
* [polars-candle](https://github.com/wdoppenberg/polars-candle) ⭐ 31 | 🐛 5 | 🌐 Python | 📅 2026-06-15 - Polars plugin for running [candle](https://github.com/huggingface/candle) ⭐ 21,073 | 🐛 908 | 🌐 Rust | 📅 2026-09-16 ML models on Polars DataFrames by [@wdoppenberg](https://github.com/wdoppenberg).
...
* [polars-fastembed](https://github.com/lmmx/polars-fastembed) ⭐ 8 | 🐛 9 | 🌐 Python | 📅 2026-09-14 - Polars plugin for embedding DataFrames by [@lmmx](https://github.com/lmmx).

#### AI

* [polars-skills](https://github.com/polars-inc/skills) ⭐ 80 | 🐛 1 | 📅 2026-08-21 - Official AI agent skills by [@polars-inc](https://github.com/polars-inc).
* [polar\_llama](https://github.com/daviddrummond95/polar_llama) ⭐ 30 | 🐛 11 | 🌐 Python | 📅 2026-09-18 - Polars plugin for interacting with LLMs in Polars by [@daviddrummond95](https://github.com/daviddrummond95).
* [polars-mcp](https://github.com/r-brink/polars-mcp) ⭐ 17 | 🐛 1 | 🌐 Python | 📅 2026-07-15 - A local MCP server for live API lookup against your installed Polars version by [@r-brink](https://github.com/r-brink).

#### Language

* [polar-whichlang](https://github.com/rmalouf/polars_whichlang) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-03-30 - Polars plugin for fast language identification by [@rmalouf](https://github.com/rmalouf).
* [polars-sbert](https://github.com/lmmx/polars-sbert) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2025-02-21 - Polars plugin for embedding data with Sentence Transformers by [@lmmx](https://github.com/lmmx).

#### Finance

* [polars-trading](https://github.com/ngriffiths13/polars-trading) ⭐ 60 | 🐛 0 | 🌐 Python | 📅 2025-09-02 - A collection of helpful polars plugins and functions for market data processing by [@ngriffiths13](https://github.com/ngriffiths13).
* [jquantstats](https://github.com/tschm/jquantstats) ⭐ 44 | 🐛 0 | 🌐 Python | 📅 2026-09-15 - Polars/Narwhals-centric tool for the analysis of financial time series data by [@tschm](https://github.com/tschm).
* [polars-bloomberg](https://github.com/MarekOzana/polars-bloomberg) ⭐ 20 | 🐛 0 | 🌐 Python | 📅 2026-07-25 - Polars plugin that extracts Bloomberg’s financial data directly into polars.DataFrame by [@MarekOzana](https://github.com/MarekOzana).
* [quantwave](https://github.com/lavs9/quantwave) ⭐ 13 | 🐛 3 | 🌐 Rust | 📅 2026-09-15 - Polars-native technical analysis (221 indicators), execution-aware backtesting, and batch/streaming parity with a Rust core and agent skill by [@lavs9](https://github.com/lavs9).
* [polars-backtest](https://github.com/Yvictor/polars_backtest_extension) ⭐ 12 | 🐛 3 | 🌐 Python | 📅 2026-07-06 - Polars extension for high-performance portfolio backtesting with Rust, Arrow, T+1 execution, and trade reports by [@Yvictor](https://github.com/Yvictor).
* [polars-order-book](https://github.com/ChristopherRussell/polars-order-book) ⭐ 7 | 🐛 0 | 🌐 Rust | 📅 2026-02-19 - Polars plugin  for enriching orderbook data with best bid and offer information by [@ChristopherRussell](https://github.com/ChristopherRussell).
* [polars\_plugin\_option\_pricing](https://github.com/oscar6echo/polars-plugin-option-pricing) ⭐ 5 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2024-11-12 - Polars plugin exposing rust crate option-pricing by [@oscar6echo](https://github.com/oscar6echo).
* [polars-fin](https://github.com/LVG77/polars-fin) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2025-07-30 - Polars plugin to calculate financial metrics by [@LVG77](https://github.com/LVG77).

#### Networking

[httpolars](https://github.com/lmmx/httpolars) ⭐ 2 | 🐛 4 | 🌐 Rust | 📅 2024-06-16 - Polars plugin for HTTP operations on columns by [@lmmx](https://github.com/lmmx).

#### Mathematical & Statistical Functions

* [polars\_ols](https://github.com/azmyrajab/polars_ols) ⭐ 203 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2025-11-03 - Polars plugin that enables fast linear model Polar expressions by [@azmyrajab](https://github.com/azmyrajab).
* [polars-stats](https://github.com/FBruzzesi/polars-stats) ⭐ 35 | 🐛 4 | 🌐 Python | 📅 2026-09-15 - Polars expression plugin that exposes scipy.stats-style probability distributions by [@FBruzzesi](https://github.com/FBruzzesi).
* [polars-pairing](https://github.com/apcamargo/polars-pairing) ⭐ 14 | 🐛 0 | 🌐 Python | 📅 2025-02-14 - Polars plugin that provides pairing functions that encode two natural numbers into a single natural number by [@apcamargo](https://github.com/apcamargo).
* [polars\_rng](https://github.com/alipatti/polars_rng) ⭐ 6 | 🐛 1 | 🌐 Python | 📅 2026-08-20 - Random number generation in Polars via the expression API by [@alipatti](https://github.com/alipatti).

#### General utilities / Performance

* [polars for Python](https://github.com/pola-rs/polars/tree/master/py-polars) ⭐ 39,767 | 🐛 2,898 | 🌐 Rust | 📅 2026-09-18 - [Python](https://www.python.org/) `polars` package to use polars DataFrame from Python.
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,721 | 🐛 262 | 🌐 Python | 📅 2026-09-18 - Python files that provides an extremely lightweight compatibility layer between Polars, Pandas, cuDF, and Modin by [@narwhals-dev](https://github.com/narwhals-dev).
...
* [polars-config-meta](https://github.com/lmmx/polars-config-meta) ⭐ 23 | 🐛 3 | 🌐 Python | 📅 2026-09-14 - Polars plugin for persistent DataFrame-level metadata by [@lmmx](https://github.com/lmmx).
...
* [polars-genson](https://github.com/lmmx/polars-genson) ⭐ 15 | 🐛 27 | 🌐 Rust | 📅 2026-08-03 - Fast JSON schema inference with support for Polars DataFrames by [@lmmx](https://github.com/lmmx).
...
* [turtle-island](https://github.com/jrycw/turtle-island) ⭐ 10 | 🐛 4 | 🌐 Python | 📅 2026-09-18 - A lightweight utility library for writing Polars Expressions by [@jrycw](https://github.com/jrycw).
...
* [polars-map](https://github.com/hafaio/polars-map) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-09-15 - Polars extension that provids a Map extension type and functions by [@hafaio](https://github.com/hafaio).
* [polarsFE](https://github.com/AdrianAntico/PolarsFE) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2026-07-06 - Polars plugins with helper functions for feature engineering, using Polars by [@AdrianAntico](https://github.com/AdrianAntico).
* [life\_polars\_plugin](https://github.com/condekind/life_polars_plugin) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2025-05-10 - Polars plugin to showcase some features of the plugin system by [@condekind](https://github.com/condekind).
* [polars-avro](https://github.com/hafaio/polars-avro) ⭐ 4 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - Polars plugin for reading and writing avro files by [@hafaio](https://github.com/hafaio).
...
* [polarscope](https://github.com/pytoned/polarscope) ⭐ 14 | 🐛 3 | 🌐 Python | 📅 2026-08-29 - Polars plugin for quick data summary, cleaning and visualization of Polars dataframes by @pytoned.
...
* [flexviz](https://github.com/flex-analytics/flexviz) ⭐ 22 | 🐛 22 | 🌐 Python | 📅 2026-09-15 - Python library for interactive, cross-filterable charts on 100M+ rows, powered by lazy Polars aggregations and Rust kernels by [@jvdd](https://github.com/jvdd).
...
* [polars-bio](http://biodatageeks.org/polars-bio/) - [Polars plugin](https://github.com/biodatageeks/polars-bio) ⭐ 199 | 🐛 50 | 🌐 Python | 📅 2026-09-16 for large-scale genomic analyses which is easy to use and considerably faster and more scalable than existing alternatives by [@biodatageeks](https://github.com/biodatageeks).
* [polars\_hash](https://github.com/ion-elgreco/polars-hash) ⭐ 94 | 🐛 4 | 🌐 Python | 📅 2026-09-14 - Python package that provides stable hashing functionality across different Polars versions by [@ion-elgreco](https://github.com/ion-elgreco).
...
* [immunum-polars](https://github.com/ENPICOM/immunum) ⭐ 32 | 🐛 19 | 🌐 Rust | 📅 2026-09-02 - high-performance plugin for antibody segmentation and numbering, with up to 1,000,000 antibodies per second on 48-core CPU machine.
...
* [polars-graphframes](https://github.com/t-ded/polars-graphframes) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2024-09-26 - Polars plugin for interconnection of graphs and networks with Frames by [@t-ded](https://github.com/t-ded).
* [polarise](https://github.com/egayer/polarise) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-04-06 - A Polars-native DataFrame styling tool for HTML visualization by [@egayer](https://github.com/egayer).
* [polars-cache](https://github.com/alipatti/polars_cache) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2026-03-30 - Polars plugin to automatically cache the result of expensive queries to disc by [@alipatti](https://github.com/alipatti).
* [polars-phonetics](https://github.com/LeCodeMinister/polars-phonetics) ⭐ 3 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2024-10-14 - Polars plugin for phonetic algorithms by [@LeCodeMinister](https://github.com/LeCodeMinister).
* [cerburus](https://github.com/rhshadrach/cerbursus) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2024-11-16 - Python package that prints Polars DataFrames with hierarchical headers by [@rhshadrach](https://github.com/rhshadrach).
* [pl\_series\_hash](https://github.com/paddymul/pl_series_hash) ⭐ 2 | 🐛 4 | 🌐 Rust | 📅 2025-11-11 - Fast series hashing for polars, useful for caching by [@paddymul](https://github.com/paddymul).
* [polars-holidays](https://github.com/mrjsj/polars-holidays) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2025-09-25 - Polars plugin for determining if a date is a holiday  by [@mrjsj](https://github.com/mrjsj).
* [raffalib-python](https://github.com/raffaem/raffalib-python) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-11 - [STATA](https://www.stata.com/)-like logging capabilities by [@raffaem](https://github.com/raffaem).

### Rust

* [polars for Rust](https://github.com/pola-rs/polars/tree/master/crates/polars) ⭐ 39,767 | 🐛 2,898 | 🌐 Rust | 📅 2026-09-18 - [Rust](https://www.rust-lang.org/) `polars` crate to use polars DataFrame with Rust.
* [GeoPolars](https://geopolars.org/) `Geopolars` pre-alpha Rust crate that extends the Polars DataFrame library for use with geospatial data (not in active development - see [top of readme](https://github.com/geopolars/geopolars) ⭐ 917 | 🐛 27 | 🌐 Python | 📅 2025-12-10).
* [plotlars](https://github.com/alceal/plotlars) ⭐ 669 | 🐛 0 | 🌐 Rust | 📅 2026-06-27 `plotlars` is a Rust library designed to facilitate the integration between the Polars data analysis library and Plotly library.
...
* [iban\_validation](https://github.com/ericqu/iban_validation) ⭐ 1 | 🐛 0 | 🌐 HTML | 📅 2026-09-08 A set of projects to facilitate validation of ibans and getting the bank identifier and branch identifier in Rust, Python and Polars by [@ericqu](https://github.com/ericqu).

### R

* [rpolars for R](https://github.com/pola-rs/r-polars) ⭐ 568 | 🐛 50 | 🌐 R | 📅 2026-09-15 - [R](https://www.r-project.org/) `rpolars` package to use polars DataFrame from R.
* [tidypolars for R](https://github.com/etiennebacher/tidypolars/) ⭐ 241 | 🐛 16 | 🌐 R | 📅 2026-09-13 `tidypolars` package to use polars with tidyverse syntax.
...
* [r-polars-dashboard](https://github.com/etiennebacher/r-polars-dashboard) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-09-17 - Dashboard comparing r-polars and py-polars APIs.

### Go

* [go-polars](https://github.com/jordandelbar/go-polars) ⭐ 88 | 🐛 5 | 🌐 Go | 📅 2025-09-01 This project creates Go bindings for Polars.

### Node.js

* [nodejs-polars for Node.js](https://github.com/pola-rs/nodejs-polars) ⭐ 751 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-15 - [Node.js](https://nodejs.org/en/) `nodejs-polars` package to use polars DataFrame from Node.js.

### Scala/Java

* [scala-polars for Scala and Java](https://github.com/chitralverma/scala-polars) ⭐ 113 | 🐛 13 | 🌐 Scala | 📅 2026-08-31 - [Scala](https://scala-lang.org/) - [Java](https://www.java.com/fr/) `scala-polars` is a library for using Polars in Scala and Java projects by [@chitralverma](https://github.com/chitralverma).

### Ruby

* [polars for Ruby](https://github.com/ankane/polars-ruby) ⭐ 995 | 🐛 1 | 🌐 Ruby | 📅 2026-09-16 - [Ruby](https://www.ruby-lang.org/en/) `polars-df` gems to use Polars with Ruby.

### .NET

* [Polars.NET](https://github.com/ErrorLSC/Polars.NET) ⭐ 178 | 🐛 0 | 🌐 C# | 📅 2026-09-17 - [C#](https://learn.microsoft.com/en-us/dotnet/csharp/) - [F#](https://learn.microsoft.com/en-us/dotnet/fsharp/) `Polars.NET` is a library to bring polars to .NET ecosystem, with idiomatic C# [Polars.NET](https://www.nuget.org/packages/Polars.NET) and F# [Polars.FSharp](https://www.nuget.org/packages/Polars.FSharp) API nuget packages provided.

## Tools Built with Polars

* [Flowfile](https://github.com/edwardvaneechoud/Flowfile) ⭐ 356 | 🐛 27 | 🌐 Python | 📅 2026-09-18 - A visual ETL tool that builds Polars pipelines on a drag-and-drop canvas or through a Polars-like Python API, with export back to standalone Polars code, by [@edwardvaneechoud](https://github.com/edwardvaneechoud).
...
* [octopolars](https://github.com/lmmx/octopolars) ⭐ 2 | 🐛 3 | 🌐 Python | 📅 2026-09-14 - Pull, filter, and walk a GitHub user's repositories with Polars by [@lmmx](https://github.com/lmmx).
...
* [Scripts and datasets for the O'Reilly book Python Polars: The Definitive Guide](https://github.com/jeroenjanssens/python-polars-the-definitive-guide) ⭐ 346 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2025-12-10 - Useful Python notebooks ordered by book chapter by [@jeroenjanssens](https://github.com/jeroenjanssens).
...
* [A Practical Comparison of Polars and Pandas](https://florianwilhelm.info/2021/05/polars_pandas_comparison_notebook/) - A tutorial that showcases several common operations in Pandas and Polars side by side to demonstrate how much easier Polars is by [@FlorianWilhelm](https://github.com/FlorianWilhelm/). There is also an accompanying [Jupyter notebook](https://github.com/FlorianWilhelm/polars_vs_pandas/blob/master/pl_vs_pd.ipynb) ⭐ 44 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2021-05-24 available.
* [Python-Polars-Tips-and-Tricks](https://github.com/StuffbyYuki/Python-Polars-Tips-and-Tricks) ⭐ 31 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2024-09-04 - Collection of source code demonstrating tips and tricks in Polars by [@StuffbyYuki](https://github.com/StuffbyYuki).
* [Polars Workshop on AWS](https://github.com/debnsuma/pycon_polars101) ⭐ 16 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2023-06-04 - A comprehensive workshop comparing Polars to Pandas, exploring a wide range of functions and features by [@debnsuma](https://github.com/debnsuma).
* [Introduction course that introduces the concept of DataFrame](https://github.com/TLouf/Py4DataSci-course) ⭐ 0 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2025-07-29 with Polars and Python. It also proposes some corrected exercices by [@TLouf](https://github.com/TLouf).
...
* [Pandas2 and Polars for Feature Engineering](https://www.hopsworks.ai/post/pandas2-and-polars-for-feature-engineering) - A blog post that compares Pandas2 and Polars for Feature Engineering tasks with Python by [@hopswork](https://github.com/logicalclocks/hopsworks) ⭐ 1,307 | 🐛 16 | 🌐 Java | 📅 2025-02-10.
...
Thanks goes to these [contributors](https://github.com/ddotta/awesome-polars/graphs/contributors) ⭐ 1,120 | 🐛 0 | 📅 2026-09-17!
