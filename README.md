...
![Last commit date](https://img.shields.io/github/last-commit/ddotta/awesome-polars?style=flat\&label=last%20commit) [![Check Links](https://github.com/ddotta/awesome-polars/actions/workflows/link-check.yml/badge.svg)](https://github.com/ddotta/awesome-polars/actions/workflows/link-check.yml) ⭐ 1,121 | 🐛 1 | 📅 2026-09-17 [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) [![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/ddotta/awesome-polars/)
...
Just follow the [guidelines](https://github.com/ddotta/awesome-polars/blob/main/.github/CONTRIBUTING.md) ⭐ 1,121 | 🐛 1 | 📅 2026-09-17 by either:

* Filling a [suggestion issue](https://github.com/ddotta/awesome-polars/issues/new?assignees=ddotta\&labels=\&template=suggestion.yml) ⭐ 1,121 | 🐛 1 | 📅 2026-09-17.
* Opening a [pull request](https://github.com/ddotta/awesome-polars/pulls) ⭐ 1,121 | 🐛 1 | 📅 2026-09-17.
...
* [polars\_readstat](https://github.com/jrothbaum/polars_readstat) ⭐ 40 | 🐛 0 | 🌐 Rust | 📅 2026-09-25 - Polars IO plugin to read SAS, Stata and SPSS file by [@jrothbaum](https://github.com/jrothbaum).
* [polars-io-tools](https://github.com/Point72/polars-io-tools) ⭐ 25 | 🐛 2 | 🌐 Python | 📅 2026-09-25 - Polars plugin extending lazy execution and predicate pushdown across external data sources (SQL, ClickHouse, Datadog, Delta Lake) by [@Point72](https://github.com/Point72/).
...
* [Ibis Python package for Polars](https://ibis-project.org/backends/polars) - [Ibis](https://github.com/ibis-project/ibis) ⭐ 6,666 | 🐛 545 | 🌐 Python | 📅 2026-09-25 is a Python library that provides a lightweight, universal interface for data wrangling. It can be used with Polars.
...
* [dataframely](https://github.com/Quantco/dataframely) ⭐ 619 | 🐛 19 | 🌐 Python | 📅 2026-09-20 - Polars plugin that provides schema and other rule validation for Polars DataFrames by [@Quantco](https://github.com/Quantco).
...
* [daffy](https://github.com/vertti/daffy/) ⭐ 59 | 🐛 3 | 🌐 Python | 📅 2026-09-26 - Decorator-first DataFrame contracts/validation (columns/dtypes/constraints) at function boundaries. Supports Polars/Pandas/PyArrow/Modin by [@vertti](https://github.com/vertti).
...
* [polars-talib](https://github.com/Yvictor/polars_ta_extension) ⭐ 251 | 🐛 4 | 🌐 Rust | 📅 2026-09-23 - Polars extension for Ta-Lib - support Ta-Lib functions in Polars expressions by [@Yvictor](https://github.com/Yvictor).
...
* [polars-candle](https://github.com/wdoppenberg/polars-candle) ⭐ 31 | 🐛 5 | 🌐 Python | 📅 2026-06-15 - Polars plugin for running [candle](https://github.com/huggingface/candle) ⭐ 21,105 | 🐛 903 | 🌐 Rust | 📅 2026-09-25 ML models on Polars DataFrames by [@wdoppenberg](https://github.com/wdoppenberg).
...
* [polars-mcp](https://github.com/r-brink/polars-mcp) ⭐ 18 | 🐛 1 | 🌐 Python | 📅 2026-07-15 - A local MCP server for live API lookup against your installed Polars version by [@r-brink](https://github.com/r-brink).
...
* [jquantstats](https://github.com/tschm/jquantstats) ⭐ 45 | 🐛 0 | 🌐 Python | 📅 2026-09-25 - Polars/Narwhals-centric tool for the analysis of financial time series data by [@tschm](https://github.com/tschm).
...
* [quantwave](https://github.com/lavs9/quantwave) ⭐ 18 | 🐛 3 | 🌐 Rust | 📅 2026-09-20 - Polars-native technical analysis (221 indicators), execution-aware backtesting, and batch/streaming parity with a Rust core and agent skill by [@lavs9](https://github.com/lavs9).
* [polars-backtest](https://github.com/Yvictor/polars_backtest_extension) ⭐ 14 | 🐛 3 | 🌐 Python | 📅 2026-07-06 - Polars extension for high-performance portfolio backtesting with Rust, Arrow, T+1 execution, and trade reports by [@Yvictor](https://github.com/Yvictor).
...
* [polars-stats](https://github.com/FBruzzesi/polars-stats) ⭐ 37 | 🐛 3 | 🌐 Python | 📅 2026-09-23 - Polars expression plugin that exposes scipy.stats-style probability distributions by [@FBruzzesi](https://github.com/FBruzzesi).
...
* [polars for Python](https://github.com/pola-rs/polars/tree/master/py-polars) ⭐ 39,865 | 🐛 2,934 | 🌐 Rust | 📅 2026-09-26 - [Python](https://www.python.org/) `polars` package to use polars DataFrame from Python.
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,723 | 🐛 264 | 🌐 Python | 📅 2026-09-26 - Python files that provides an extremely lightweight compatibility layer between Polars, Pandas, cuDF, and Modin by [@narwhals-dev](https://github.com/narwhals-dev).
...
* [polars-genson](https://github.com/lmmx/polars-genson) ⭐ 15 | 🐛 28 | 🌐 Rust | 📅 2026-09-25 - Fast JSON schema inference with support for Polars DataFrames by [@lmmx](https://github.com/lmmx).
...
* [flexviz](https://github.com/flex-analytics/flexviz) ⭐ 46 | 🐛 36 | 🌐 Python | 📅 2026-09-25 - Python library for interactive, cross-filterable charts on 100M+ rows, powered by lazy Polars aggregations and Rust kernels by [@jvdd](https://github.com/jvdd).
...
* [immunum-polars](https://github.com/ENPICOM/immunum) ⭐ 33 | 🐛 19 | 🌐 Rust | 📅 2026-09-02 - high-performance plugin for antibody segmentation and numbering, with up to 1,000,000 antibodies per second on 48-core CPU machine.
...
* [polars for Rust](https://github.com/pola-rs/polars/tree/master/crates/polars) ⭐ 39,865 | 🐛 2,934 | 🌐 Rust | 📅 2026-09-26 - [Rust](https://www.rust-lang.org/) `polars` crate to use polars DataFrame with Rust.
* [GeoPolars](https://geopolars.org/) `Geopolars` pre-alpha Rust crate that extends the Polars DataFrame library for use with geospatial data (not in active development - see [top of readme](https://github.com/geopolars/geopolars) ⭐ 920 | 🐛 27 | 🌐 Python | 📅 2026-09-22).
...
* [rpolars for R](https://github.com/pola-rs/r-polars) ⭐ 569 | 🐛 50 | 🌐 R | 📅 2026-09-23 - [R](https://www.r-project.org/) `rpolars` package to use polars DataFrame from R.
...
* [r-polars-dashboard](https://github.com/etiennebacher/r-polars-dashboard) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-09-25 - Dashboard comparing r-polars and py-polars APIs.
...
* [polars for Ruby](https://github.com/ankane/polars-ruby) ⭐ 997 | 🐛 1 | 🌐 Ruby | 📅 2026-09-23 - [Ruby](https://www.ruby-lang.org/en/) `polars-df` gems to use Polars with Ruby.

### .NET

* [Polars.NET](https://github.com/ErrorLSC/Polars.NET) ⭐ 181 | 🐛 0 | 🌐 C# | 📅 2026-09-26 - [C#](https://learn.microsoft.com/en-us/dotnet/csharp/) - [F#](https://learn.microsoft.com/en-us/dotnet/fsharp/) `Polars.NET` is a library to bring polars to .NET ecosystem, with idiomatic C# [Polars.NET](https://www.nuget.org/packages/Polars.NET) and F# [Polars.FSharp](https://www.nuget.org/packages/Polars.FSharp) API nuget packages provided.

## Tools Built with Polars

* [Flowfile](https://github.com/edwardvaneechoud/Flowfile) ⭐ 362 | 🐛 27 | 🌐 Python | 📅 2026-09-25 - A visual ETL tool that builds Polars pipelines on a drag-and-drop canvas or through a Polars-like Python API, with export back to standalone Polars code, by [@edwardvaneechoud](https://github.com/edwardvaneechoud).
...
Thanks goes to these [contributors](https://github.com/ddotta/awesome-polars/graphs/contributors) ⭐ 1,121 | 🐛 1 | 📅 2026-09-17!
