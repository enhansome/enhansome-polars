...
![Last commit date](https://img.shields.io/github/last-commit/ddotta/awesome-polars?style=flat\&label=last%20commit) [![Check Links](https://github.com/ddotta/awesome-polars/actions/workflows/link-check.yml/badge.svg)](https://github.com/ddotta/awesome-polars/actions/workflows/link-check.yml) ⭐ 1,115 | 🐛 2 | 📅 2026-08-07 [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) [![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/ddotta/awesome-polars/)
...
Just follow the [guidelines](https://github.com/ddotta/awesome-polars/blob/main/.github/CONTRIBUTING.md) ⭐ 1,115 | 🐛 2 | 📅 2026-08-07 by either:

* Filling a [suggestion issue](https://github.com/ddotta/awesome-polars/issues/new?assignees=ddotta\&labels=\&template=suggestion.yml) ⭐ 1,115 | 🐛 2 | 📅 2026-08-07.
* Opening a [pull request](https://github.com/ddotta/awesome-polars/pulls) ⭐ 1,115 | 🐛 2 | 📅 2026-08-07.
...
* [Ibis Python package for Polars](https://ibis-project.org/backends/polars) - [Ibis](https://github.com/ibis-project/ibis) ⭐ 6,623 | 🐛 524 | 🌐 Python | 📅 2026-08-12 is a Python library that provides a lightweight, universal interface for data wrangling. It can be used with Polars.
...
* [polars-st](https://github.com/Oreilles/polars-st) ⭐ 190 | 🐛 9 | 🌐 Python | 📅 2026-08-06 - Polars plugin that provides geographical/spatial operations on Polars DataFrames, Series, and Expressions by [@Oreilles](https://github.com/Oreilles).
...
* [daffy](https://github.com/vertti/daffy/) ⭐ 58 | 🐛 2 | 🌐 Python | 📅 2026-08-12 - Decorator-first DataFrame contracts/validation (columns/dtypes/constraints) at function boundaries. Supports Polars/Pandas/PyArrow/Modin by [@vertti](https://github.com/vertti).
...
* [tubular](https://github.com/azukds/tubular) ⭐ 108 | 🐛 74 | 🌐 Python | 📅 2026-08-12 - Scikit-learn pipeline compatible pre-processing steps by [@azukds](https://github.com/azukds).
* [polars-candle](https://github.com/wdoppenberg/polars-candle) ⭐ 31 | 🐛 5 | 🌐 Python | 📅 2026-06-15 - Polars plugin for running [candle](https://github.com/huggingface/candle) ⭐ 20,896 | 🐛 919 | 🌐 Rust | 📅 2026-08-06 ML models on Polars DataFrames by [@wdoppenberg](https://github.com/wdoppenberg).
...
* [polars-skills](https://github.com/polars-inc/skills) ⭐ 66 | 🐛 4 | 📅 2026-07-22 - Official AI agent skills by [@polars-inc](https://github.com/polars-inc).
...
* [jquantstats](https://github.com/tschm/jquantstats) ⭐ 42 | 🐛 6 | 🌐 Python | 📅 2026-08-11 - Polars/Narwhals-centric tool for the analysis of financial time series data by [@tschm](https://github.com/tschm).
...
* [quantwave](https://github.com/lavs9/quantwave) ⭐ 9 | 🐛 2 | 🌐 Rust | 📅 2026-08-12 - Polars-native technical analysis (221 indicators), execution-aware backtesting, and batch/streaming parity with a Rust core and agent skill by [@lavs9](https://github.com/lavs9).
...
* [polars for Python](https://github.com/pola-rs/polars/tree/master/py-polars) ⭐ 39,343 | 🐛 2,843 | 🌐 Rust | 📅 2026-08-12 - [Python](https://www.python.org/) `polars` package to use polars DataFrame from Python.
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,695 | 🐛 253 | 🌐 Python | 📅 2026-08-13 - Python files that provides an extremely lightweight compatibility layer between Polars, Pandas, cuDF, and Modin by [@narwhals-dev](https://github.com/narwhals-dev).
...
* [turtle-island](https://github.com/jrycw/turtle-island) ⭐ 10 | 🐛 4 | 🌐 Python | 📅 2026-08-12 - A lightweight utility library for writing Polars Expressions by [@jrycw](https://github.com/jrycw).
...
* [polars-nexpresso](https://github.com/heshamdar/polars-nexpresso) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2026-08-11 - Polars plugins for generating Polars expressions to work with nested data structures by [@heshamdar](https://github.com/heshamdar).
...
* [polars-bio](http://biodatageeks.org/polars-bio/) - [Polars plugin](https://github.com/biodatageeks/polars-bio) ⭐ 188 | 🐛 45 | 🌐 Python | 📅 2026-08-12 for large-scale genomic analyses which is easy to use and considerably faster and more scalable than existing alternatives by [@biodatageeks](https://github.com/biodatageeks).
...
* [polars for Rust](https://github.com/pola-rs/polars/tree/master/crates/polars) ⭐ 39,343 | 🐛 2,843 | 🌐 Rust | 📅 2026-08-12 - [Rust](https://www.rust-lang.org/) `polars` crate to use polars DataFrame with Rust.
...
* [plotlars](https://github.com/alceal/plotlars) ⭐ 666 | 🐛 0 | 🌐 Rust | 📅 2026-06-27 `plotlars` is a Rust library designed to facilitate the integration between the Polars data analysis library and Plotly library.
...
* [r-polars-dashboard](https://github.com/etiennebacher/r-polars-dashboard) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-08-12 - Dashboard comparing r-polars and py-polars APIs.
...
* [nodejs-polars for Node.js](https://github.com/pola-rs/nodejs-polars) ⭐ 740 | 🐛 6 | 🌐 TypeScript | 📅 2026-07-31 - [Node.js](https://nodejs.org/en/) `nodejs-polars` package to use polars DataFrame from Node.js.
...
* [polars for Ruby](https://github.com/ankane/polars-ruby) ⭐ 992 | 🐛 2 | 🌐 Ruby | 📅 2026-08-12 - [Ruby](https://www.ruby-lang.org/en/) `polars-df` gems to use Polars with Ruby.
...
Thanks goes to these [contributors](https://github.com/ddotta/awesome-polars/graphs/contributors) ⭐ 1,115 | 🐛 2 | 📅 2026-08-07!
