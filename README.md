...
![Last commit date](https://img.shields.io/github/last-commit/ddotta/awesome-polars?style=flat\&label=last%20commit) [![Check Links](https://github.com/ddotta/awesome-polars/actions/workflows/link-check.yml/badge.svg)](https://github.com/ddotta/awesome-polars/actions/workflows/link-check.yml) ⭐ 1,117 | 🐛 1 | 📅 2026-08-26 [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) [![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/ddotta/awesome-polars/)
...
Just follow the [guidelines](https://github.com/ddotta/awesome-polars/blob/main/.github/CONTRIBUTING.md) ⭐ 1,117 | 🐛 1 | 📅 2026-08-26 by either:

* Filling a [suggestion issue](https://github.com/ddotta/awesome-polars/issues/new?assignees=ddotta\&labels=\&template=suggestion.yml) ⭐ 1,117 | 🐛 1 | 📅 2026-08-26.
* Opening a [pull request](https://github.com/ddotta/awesome-polars/pulls) ⭐ 1,117 | 🐛 1 | 📅 2026-08-26.
...
* [polars\_readstat](https://github.com/jrothbaum/polars_readstat) ⭐ 38 | 🐛 1 | 🌐 Rust | 📅 2026-09-10 - Polars IO plugin to read SAS, Stata and SPSS file by [@jrothbaum](https://github.com/jrothbaum).
* [polars-io-tools](https://github.com/Point72/polars-io-tools) ⭐ 24 | 🐛 2 | 🌐 Python | 📅 2026-09-08 - Polars plugin extending lazy execution and predicate pushdown across external data sources (SQL, ClickHouse, Datadog, Delta Lake) by [@Point72](https://github.com/Point72/).
...
* [Ibis Python package for Polars](https://ibis-project.org/backends/polars) - [Ibis](https://github.com/ibis-project/ibis) ⭐ 6,661 | 🐛 538 | 🌐 Python | 📅 2026-09-09 is a Python library that provides a lightweight, universal interface for data wrangling. It can be used with Polars.
...
* [polars-permute-plugin](https://github.com/lmmx/polars-permute-plugin) ⭐ 15 | 🐛 2 | 🌐 Python | 📅 2026-09-07 - Polars plugin for easily reordering DataFrame columns by [@lmmx](https://github.com/lmmx).
* [polars-expr-hopper](https://github.com/lmmx/polars-expr-hopper) ⭐ 8 | 🐛 1 | 🌐 Python | 📅 2026-09-07 - Polars plugin providing a hopper of expressions for automatic, schema-aware application by [@lmmx](https://github.com/lmmx).
* [polars-schema-index](https://github.com/lmmx/polars-schema-index) ⭐ 6 | 🐛 1 | 🌐 Python | 📅 2026-09-07 - Polars plugin for flattening nested data by [@lmmx](https://github.com/lmmx).
...
* [polars-st](https://github.com/Oreilles/polars-st) ⭐ 195 | 🐛 9 | 🌐 Python | 📅 2026-08-06 - Polars plugin that provides geographical/spatial operations on Polars DataFrames, Series, and Expressions by [@Oreilles](https://github.com/Oreilles).
* [polars-h3](https://github.com/Filimoa/polars-h3) ⭐ 130 | 🐛 2 | 🌐 Python | 📅 2026-09-03 - Efficient hexagonal indexing for large-scale geospatial analysis by [@Filimoa](https://github.com/Filimoa).
...
* [dataframely](https://github.com/Quantco/dataframely) ⭐ 618 | 🐛 19 | 🌐 Python | 📅 2026-09-08 - Polars plugin that provides schema and other rule validation for Polars DataFrames by [@Quantco](https://github.com/Quantco).
...
* [daffy](https://github.com/vertti/daffy/) ⭐ 59 | 🐛 1 | 🌐 Python | 📅 2026-09-12 - Decorator-first DataFrame contracts/validation (columns/dtypes/constraints) at function boundaries. Supports Polars/Pandas/PyArrow/Modin by [@vertti](https://github.com/vertti).
* [truthound](https://github.com/seadonggyun4/truthound) ⭐ 19 | 🐛 0 | 🌐 Python | 📅 2026-09-12 - Enterprise data quality framework with 289 validators, auto-profiling, and zero-configuration schema inference by [@seadonggyun4](https://github.com/seadonggyun4).
...
* [iban\_validation\_polars](https://github.com/ericqu/iban_validation/tree/main/iban_validation_polars) ⭐ 0 | 🐛 0 | 🌐 HTML | 📅 2026-09-08 - A package to facilitate validation of IBANs and getting bank identifier and branch identifier as a Polars plugin by [@ericqu](https://github.com/ericqu).
...
* [polars-ds](https://github.com/abstractqqq/polars_ds_extension) ⭐ 653 | 🐛 8 | 🌐 Rust | 📅 2026-08-16 - Polars extension for general data science use cases by [@abstractqqq](https://github.com/abstractqqq).
...
* [polars-candle](https://github.com/wdoppenberg/polars-candle) ⭐ 31 | 🐛 5 | 🌐 Python | 📅 2026-06-15 - Polars plugin for running [candle](https://github.com/huggingface/candle) ⭐ 21,028 | 🐛 901 | 🌐 Rust | 📅 2026-09-11 ML models on Polars DataFrames by [@wdoppenberg](https://github.com/wdoppenberg).
...
* [polars-fastembed](https://github.com/lmmx/polars-fastembed) ⭐ 8 | 🐛 9 | 🌐 Python | 📅 2026-09-07 - Polars plugin for embedding DataFrames by [@lmmx](https://github.com/lmmx).

#### AI

* [polars-skills](https://github.com/polars-inc/skills) ⭐ 79 | 🐛 1 | 📅 2026-08-21 - Official AI agent skills by [@polars-inc](https://github.com/polars-inc).
* [polar\_llama](https://github.com/daviddrummond95/polar_llama) ⭐ 30 | 🐛 10 | 🌐 Python | 📅 2026-08-17 - Polars plugin for interacting with LLMs in Polars by [@daviddrummond95](https://github.com/daviddrummond95).
...
* [jquantstats](https://github.com/tschm/jquantstats) ⭐ 44 | 🐛 0 | 🌐 Python | 📅 2026-09-08 - Polars/Narwhals-centric tool for the analysis of financial time series data by [@tschm](https://github.com/tschm).
...
* [quantwave](https://github.com/lavs9/quantwave) ⭐ 12 | 🐛 2 | 🌐 Rust | 📅 2026-09-13 - Polars-native technical analysis (221 indicators), execution-aware backtesting, and batch/streaming parity with a Rust core and agent skill by [@lavs9](https://github.com/lavs9).
...
* [polars for Python](https://github.com/pola-rs/polars/tree/master/py-polars) ⭐ 39,718 | 🐛 2,893 | 🌐 Rust | 📅 2026-09-13 - [Python](https://www.python.org/) `polars` package to use polars DataFrame from Python.
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,720 | 🐛 257 | 🌐 Python | 📅 2026-09-13 - Python files that provides an extremely lightweight compatibility layer between Polars, Pandas, cuDF, and Modin by [@narwhals-dev](https://github.com/narwhals-dev).
...
* [polars-config-meta](https://github.com/lmmx/polars-config-meta) ⭐ 23 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Polars plugin for persistent DataFrame-level metadata by [@lmmx](https://github.com/lmmx).
...
* [turtle-island](https://github.com/jrycw/turtle-island) ⭐ 10 | 🐛 4 | 🌐 Python | 📅 2026-09-10 - A lightweight utility library for writing Polars Expressions by [@jrycw](https://github.com/jrycw).
...
* [polars-map](https://github.com/hafaio/polars-map) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-09-02 - Polars extension that provids a Map extension type and functions by [@hafaio](https://github.com/hafaio).
...
* [flexviz](https://github.com/flex-analytics/flexviz) ⭐ 17 | 🐛 21 | 🌐 Python | 📅 2026-09-11 - Python library for interactive, cross-filterable charts on 100M+ rows, powered by lazy Polars aggregations and Rust kernels by [@jvdd](https://github.com/jvdd).
...
* [polars\_ta](https://github.com/wukan1986/polars_ta) ⭐ 263 | 🐛 7 | 🌐 Python | 📅 2026-02-11 - Python package that provides technical indicator operators rewritten in Polars by [@wukan1986](https://github.com/wukan1986).
...
* [polars-bio](http://biodatageeks.org/polars-bio/) - [Polars plugin](https://github.com/biodatageeks/polars-bio) ⭐ 199 | 🐛 49 | 🌐 Python | 📅 2026-09-12 for large-scale genomic analyses which is easy to use and considerably faster and more scalable than existing alternatives by [@biodatageeks](https://github.com/biodatageeks).
* [polars\_hash](https://github.com/ion-elgreco/polars-hash) ⭐ 94 | 🐛 0 | 🌐 Python | 📅 2026-09-08 - Python package that provides stable hashing functionality across different Polars versions by [@ion-elgreco](https://github.com/ion-elgreco).
...
* [polars for Rust](https://github.com/pola-rs/polars/tree/master/crates/polars) ⭐ 39,718 | 🐛 2,893 | 🌐 Rust | 📅 2026-09-13 - [Rust](https://www.rust-lang.org/) `polars` crate to use polars DataFrame with Rust.
* [GeoPolars](https://geopolars.org/) `Geopolars` pre-alpha Rust crate that extends the Polars DataFrame library for use with geospatial data (not in active development - see [top of readme](https://github.com/geopolars/geopolars) ⭐ 915 | 🐛 27 | 🌐 Python | 📅 2025-12-10).
...
* [iban\_validation](https://github.com/ericqu/iban_validation) ⭐ 0 | 🐛 0 | 🌐 HTML | 📅 2026-09-08 A set of projects to facilitate validation of ibans and getting the bank identifier and branch identifier in Rust, Python and Polars by [@ericqu](https://github.com/ericqu).

### R

* [rpolars for R](https://github.com/pola-rs/r-polars) ⭐ 568 | 🐛 54 | 🌐 R | 📅 2026-09-13 - [R](https://www.r-project.org/) `rpolars` package to use polars DataFrame from R.
* [tidypolars for R](https://github.com/etiennebacher/tidypolars/) ⭐ 241 | 🐛 16 | 🌐 R | 📅 2026-09-08 `tidypolars` package to use polars with tidyverse syntax.
...
* [r-polars-dashboard](https://github.com/etiennebacher/r-polars-dashboard) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-09-12 - Dashboard comparing r-polars and py-polars APIs.
...
* [nodejs-polars for Node.js](https://github.com/pola-rs/nodejs-polars) ⭐ 752 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-28 - [Node.js](https://nodejs.org/en/) `nodejs-polars` package to use polars DataFrame from Node.js.
...
* [octopolars](https://github.com/lmmx/octopolars) ⭐ 2 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Pull, filter, and walk a GitHub user's repositories with Polars by [@lmmx](https://github.com/lmmx).
...
* [Pandas2 and Polars for Feature Engineering](https://www.hopsworks.ai/post/pandas2-and-polars-for-feature-engineering) - A blog post that compares Pandas2 and Polars for Feature Engineering tasks with Python by [@hopswork](https://github.com/logicalclocks/hopsworks) ⭐ 1,306 | 🐛 16 | 🌐 Java | 📅 2025-02-10.
...
Thanks goes to these [contributors](https://github.com/ddotta/awesome-polars/graphs/contributors) ⭐ 1,117 | 🐛 1 | 📅 2026-08-26!
